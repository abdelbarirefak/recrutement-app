...
<body class="bg-slate-50 flex items-center justify-center min-h-screen p-4">
    ...
    <div class="bg-white p-8 sm:p-10 rounded-2xl shadow-xl shadow-slate-200/50 max-w-md w-full border border-slate-100">
        ...
        <% if (request.getAttribute("errorMessage") != null) { %>
            <div class="bg-red-50 border border-red-100 text-red-600 px-4 py-3 rounded-lg text-sm flex items-center gap-2 mb-6">
        ...
        <div class="mt-8 pt-6 border-t border-slate-100 text-center">
            <p class="text-sm text-slate-500">
                ...
                <a href="register.jsp" class="text-indigo-600 font-semibold hover:text-indigo-700 transition-colors">Créer un compte</a>
            </p>
